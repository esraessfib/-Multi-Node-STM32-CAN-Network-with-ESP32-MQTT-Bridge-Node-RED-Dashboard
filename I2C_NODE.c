/*
Quand le n�ud central envoie une requ�te CAN (ID 0x550), le STM32 :
    - Re�oit la requ�te (interruption CAN)
    - Lit la temp�rature du DS1621
    - Envoie la r�ponse via CAN (ID 0x681)
*/
...
/* ================== CAN Definitions ================== */
#define CAN_ID_TEMP_REQUEST   0x550  // ID pour recevoir la requ�te
#define CAN_ID_TEMP_RESPONSE  0x681  // ID pour envoyer la r�ponse
...
void CAN_Config(void)
{
    ...
    /* Configuration du filtre pour recevoir les requ�tes */
...
/* ================== Configuration USART3 pour debug ================== */
void USART3_init(void)
{
    // Enable clocks
...
/**
  *   D�marrage de la conversion DS1621
  */
void Start_DS1621_Conv(void) 
{
...
/*
  *  Lecture de la temp�rature du DS1621
  *  Temp�rature en �C
 */
float I2C_ReadTemperature(void) 
{
...
/*
  *   Envoi de la temp�rature via CAN
*/
void CAN_Send_Temperature(float temp)
{
    CanTxMsg TxMessage;
    ...
    /* Conversion temp�rature en format fixe (x10 pour 1 d�cimale) */
    temp_fixed = (uint8_t)(temp * 10);
    
    /* Remplissage des donn�es */
    TxMessage.Data[0] = CAN_ID_TEMP_RESPONSE ; 
...
int main(void)
{
    ...
    /* Attendre premi�re conversion (750ms) */
    delay_ms(800);
